...
\cref{mnt:eager-lazy-datatypes}, unlike the \mintinline{ml}|list|
datatype, demands a thunk as the second argument to the
\mintinline{ml}|More| constructor, to delay evaluation. We could have
instead appealed to lazy constructors (e.g. \mintinline{ml}|lazy|) or
