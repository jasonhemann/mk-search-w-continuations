...
% semantic.sty conflicts with current XeTeX/unicode-math and is unused in this file.
% \usepackage{semantic}
...
\begin{listing}
\begin{minted}[autogobble,stripall,linenos]{ocaml}
...
The \mintinline{ocaml}|stream| datatype we define in
\cref{mnt:eager-lazy-datatypes}, unlike the \mintinline{ocaml}|list|
datatype, demands a thunk as the second argument to the
\mintinline{ocaml}|More| constructor, to delay evaluation. We could have
instead appealed to lazy constructors (e.g. \mintinline{ocaml}|lazy|) or
...
streams. \citeauthor{wadler1998add}, in \citetitle{wadler1998add},
...
reconstruct in full detail \citeposs{danvy2002unifying} construction
...
through \citeposs{wadler1998add} even streams before we proceed
forward into our own curious stream datatype.

using \citeposs{hagino1989codatatypes} codatatype syntax.
...
\begin{listing}
\begin{minted}[fontsize=\footnotesize,autogobble,stripall,linenos]{racket}
(define (run . args)
  (cond
...
% https://www.ccs.neu.edu/home/shivers/papers/ordered-cont.pdf - Shivers Ordered Continuations
% https://dl.acm.org/doi/pdf/10.1145/1291151.1291179 Kennedy good section on extending to multiple continuations
% https://link.springer.com/article/10.1023/A:1020887011500
...
% Include currently uncited bibliography entries for bibliography/build validation.
\nocite{hagino1989codatatypes,spivey2000combinators,deschreye1999logic,seres1999algebra,byrd2017unifiedapproach,frigo1994implementing,robinson1965machine,kiselyov2005backtracking,rozplokhas2019certified}
\nocite{wand2004relating,hinze2000deriving,danvy2002unifying,danvy2007barron,hughes1986novel,bove2005modelling,danvy-hatcliff-cps-after-strictness,hatcliff-danvy-generic-cps,bieniusa-thiemann-cps-transform-monad,wadler1998add}
\nocite{danvy-functional-correspondence-evaluators-machines,danvy-back-to-direct-style,danvy-three-steps-cps,danvy-evaluation-contexts-continuations-rest,lawall-danvy-continuation-based-partial-eval,pottier-revisiting-cps-transformation,danvy-journey-interpreters-compilers-vm,desouter2016towards-flexible-goal-oriented}
\nocite{hillerstrom-lindley-atkey-cps-effect-handlers,biernacki-danvy-millikin-dynamic-cps,wand-continuation-based-program-transformation-strategies,pirog2016eilenberg-moore-monoids,schrijvers2012search-combinators,kidney2021algebras-weighted-search,pirog2017backtracking-cut-left-zero,rivas2018unified-monadic-applicative-nondeterminism}
\nocite{PlotkinPower2002,PlotkinPower2003,VandenbrouckeSchrijvers2023,Wadler1989,dix1996semantics,fordan1999projection,jaffar1992output}
\nocite{jaffar1993projecting,haynes1987logiccontinuations,kowalski1998executing,sato1990completed,vandevel2010theories,vanhentenryck1995backtracking,wand1983semantic,vasak1986survey-control-facilities-logic-programming}
\nocite{sabry-felleisen1993reasoning-cps,dybvig-peyton-jones-sabry2007monadic-delimited-continuations}
\nocite{meseguer1997interleaved,flanagan1993essence,hinze1996efficient,hinze1999deriving,hinze2001prolog,brassel2010transforming,michel2004decomposition,schrijvers2009monadic}
